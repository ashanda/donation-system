...
>
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('assets-main/vendor/libs/apex-charts/apex-charts.css') }}" />
  ...
  <body>
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('assets-main/vendor/libs/apex-charts/apexcharts.js') }}"></script>

    <!-- Main JS -->
    <script src="{{ asset('assets-main/js/main.js') }}"></script>

    <!-- Page JS -->
    <script src="{{ asset('assets-main/js/dashboards-analytics.js') }}"></script>
