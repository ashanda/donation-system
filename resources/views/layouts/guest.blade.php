...
<html
  ...
  data-assets-main-path="../assets-main/"
...
>
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('assets-main-main/vendor/fonts/boxicons.css') }}" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('assets-main/vendor/css/core.cs') }}s" class="template-customizer-core-css" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('assets-main/vendor/css/pages/page-auth.css') }}" />
    <!-- Helpers -->
  ...
  <body>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder text-capitalize">Donation System</span>
                </a>
              </div>
              <!-- /Logo -->
    ...
    <!-- Core JS -->
    <!-- build:js assets-main/vendor/js/core.js -->
